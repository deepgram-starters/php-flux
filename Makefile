...
.PHONY: help check check-prereqs init install install-backend install-frontend start start-backend start-frontend test update clean status eject-frontend

# Default target: show help
help:
	@echo "PHP Flux - Available Commands"
	@echo "=============================="
	@echo ""
	@echo "Setup:"
...
# Install all dependencies (alias for init without submodule step)
install: init
